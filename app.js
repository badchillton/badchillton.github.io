...
const ZEROVOL = "https://api.spotify.com/v1/me/player/volume?volume_percent=10";
const FULLVOL = "https://api.spotify.com/v1/me/player/volume?volume_percent=100";
...
function lowVol(){
    callApi( "PUT", ZEROVOL , null, handleApiResponse );
}

function fullVol(){
    callApi( "PUT", FULLVOL , null, handleApiResponse );
}
